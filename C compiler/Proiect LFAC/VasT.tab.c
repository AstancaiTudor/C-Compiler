...
bool verificare_tip(const char* currentType, const char* var_name);
bool verificare_clasa(const char* currentType, const char* class_name);
...
{
       0,    62,    62,    66,    67,    70,    70,    71,    74,    75,
      79,    78,    93,    92,   109,   133,   108,   146,   169,   145,
     183,   192,   191,   198,   201,   201,   204,   205,   206,   207,
     208,   211,   212,   216,   215,   227,   226,   242,   243,   242,
     263,   262,   284,   283,   308,   307,   337,   336,   355,   370,
     370,   384,   384,   398,   401,   425,   424,   441,   441,   442,
     446,   445,   453,   454,   458,   457,   496,   495,   522,   521,
     552,   553,   552,   586,   585,   626,   625,   664,   665,   668,
     669,   670,   671,   672,   673,   676,   677,   681,   680,   765,
     764,   846,   845,   913,   912,   980,   980,   981,   994,   993,
    1017,  1016,  1041,  1040,  1065,  1064,  1088,  1087,  1111,  1110,
    1136,  1135,  1159,  1158,  1182,  1182,  1183,  1192,  1200,  1221,
    1246,  1251,  1256,  1268,  1269,  1270,  1273,  1274,  1273,  1314,
    1313,  1317,  1318
};
#endif
...
#line 1462 "VasT.tab.c"
    break;

  case 5: /* $@1: %empty  */
#line 70 "VasT.y"
       {currentDomain="global";}
#line 1468 "VasT.tab.c"
    break;
...
#line 1628 "VasT.tab.c"
    break;

  case 24: /* $@9: %empty  */
#line 201 "VasT.y"
            { currentDomain = "main"; }
#line 1634 "VasT.tab.c"
    break;
...
#line 1648 "VasT.tab.c"
    break;

  case 34: /* var: TYPE NUME $@10 asg  */
#line 225 "VasT.y"
            {ok_type=false;}
#line 1654 "VasT.tab.c"
    break;
...
#line 1739 "VasT.tab.c"
    break;

  case 41: /* var: TYPE NUME ASSIGN expr $@14 asg  */
#line 282 "VasT.y"
              {ok_type=false;}
#line 1745 "VasT.tab.c"
    break;
...
#line 1858 "VasT.tab.c"
    break;

  case 49: /* $@18: %empty  */
#line 370 "VasT.y"
           {ok_eval=1;}
#line 1864 "VasT.tab.c"
    break;
...
#line 1882 "VasT.tab.c"
    break;

  case 51: /* $@19: %empty  */
#line 384 "VasT.y"
             {ok_typeof=1;}
#line 1888 "VasT.tab.c"
    break;
...
#line 2083 "VasT.tab.c"
    break;

  case 70: /* $@26: %empty  */
#line 552 "VasT.y"
                                {restOfDim=atoi(arrayDim);}
#line 2089 "VasT.tab.c"
    break;
...
#line 2835 "VasT.tab.c"
    break;

  case 114: /* $@43: %empty  */
#line 1182 "VasT.y"
          { ok_tipuri=1;}
#line 2841 "VasT.tab.c"
    break;

  case 115: /* expr: '@' $@43 apel_func  */
#line 1182 "VasT.y"
                                    { ok_func=1;}
#line 2847 "VasT.tab.c"
    break;
...
#line 3034 "VasT.tab.c"
    break;

  case 131: /* param: ',' param  */
#line 1317 "VasT.y"
                {contor_param++;}
#line 3040 "VasT.tab.c"
    break;


#line 3044 "VasT.tab.c"
